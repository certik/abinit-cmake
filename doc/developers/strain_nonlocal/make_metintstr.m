...
rankinarr  = {rank  ,rank+1,rank  ,rank+1,rank+2,rank+3};
rankoutarr = {rank+3,rank+2,rank+1,rank  ,rank+1,rank  };
...
Write[outfile,TextForm["ntnin="],FortranForm[limitin],TextForm["#"]];
Write[outfile,TextForm["ntnout="],FortranForm[limitout],TextForm["#"]];
Write[outfile,TextForm["allocate(cm(3,"],FortranForm[limitin],
 TextForm[","],FortranForm[limitout],TextForm[")#"]];
Write[outfile,TextForm["cm(:,:,:)=0.#"]];
