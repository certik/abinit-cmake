...
!This section has been created automatically by the script Abilint (TD). Do not modify the following lines by hand.
 ...
 use interfaces_14poisson, except_this_one => Psolver_hartree
...
!!$     bndcode = 'S'
  ...
  if (dtset%usewvl == 0) then
     ...
     n1=dtset%wvl_internal%dpSize(1)
     n2=dtset%wvl_internal%dpSize(2)
     n3=dtset%wvl_internal%dpSize(3)
  end if
...
! Warning : enxc and evxc are meaningless.
  call PSolver(bndcode, datacode, mpi_enreg%me, mpi_enreg%nproc, n1, n2, n3,& 
