...
!This section has been created automatically by the script Abilint (TD). Do not modify the following lines by hand.
 ...
 use interfaces_12parser, except_this_one => inarray
...
!DEBUG
!write(6, '(2a)' )' inarray : token=',trim(cs)
!write(6, '(a,i4)' )' inarray : narr=',narr
!write(6, '(2a)' )' inarray : typevarphys=',typevarphys
!ENDDEBUG
...
!In case of 'LEN' and 'ENE', try to identify the unit
 if(typevarphys=='LEN' .or. typevarphys=='ENE')then
  do
...
!  DEBUG
!  write(6,*)' inarray : string(b1+1:)=',string(b1+1:)
!  write(6,*)' inarray : b2=',b2
!  write(6,*)' typevarphys==',typevarphys
!  ENDDEBUG
...
!DEBUG
!write(6,*)' inarray : exit '
!write(6,*)' dprarr(1:narr)==',dprarr(1:narr)
!ENDDEBUG
