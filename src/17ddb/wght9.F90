...
!!
!! COPYRIGHT
!! Copyright (C) 1999-2008 ABINIT group (XG,JCC)
...
!DEBUG
!write(6,*)'factor,ngqpt',factor,ngqpt(1:3)
!ENDDEBUG
...
!    DEBUG
!    if(ia==1 .and. ib==10)&
!    &     write(6, '(a,i5,a,3es16.6)' )' irpt=',irpt,'  rdiff=',rdiff(1:3)
!    ENDDEBUG
    end if
...
!    DEBUG
!    if(ia==1 .and. ib==10)&
!    &     write(6,*)' wghatm(ia,ib,irpt)=',wghatm(ia,ib,irpt)
!    ENDDEBUG
...
!   DEBUG
!   write(06, '(a,3i5)' )' atom1, atom2, irpt ; rpt ; wghatm ',ia,ib,irpt
!   write(06, '(3es16.6,es18.6)' )&
