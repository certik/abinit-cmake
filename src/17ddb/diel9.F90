...
!!
!! COPYRIGHT
!! Copyright (C) 1999-2008 ABINIT group (XG,XW)
...
!!
!! CHILDREN
!!      alignph,dielmore9,leave_new,wrtout
!!
!! SOURCE
...
!This section has been created automatically by the script Abilint (TD). Do not modify the following lines by hand.
 ...
 use interfaces_17ddb, except_this_one => diel9
...
!Local variables -------------------------
!scalars
 integer :: dieflag,i1,i2,idir1,idir2,ifreq,ii,imode,ipert1,ipert2,iphl2,nfreq
...
&    qphon(1)*qphon(3)*epsinf(1,3)+qphon(2)*qphon(3)*epsinf(2,3))
    ...
    write(6, '(3f10.5,es18.8)' )qphon,eps
   end if
  end do
...
! End of the condition of nph2l does not vanish
 ...
 deallocate(frdiel,modez,oscstr)
