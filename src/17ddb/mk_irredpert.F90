...
!!
!! INPUTS
!!  hdr1 = header type containing dimensions and perturbation infos
!!  iatom = atom of perturbation being treated
!!  idir = direction of perturbation being treated
...
!Arguments ------------------------------------
!scalars
 integer,intent(in) :: iatom,idir,iqptfull,natom,nbranch,nqpt,nsym,qtimrev
...
!Local variables -------------------------
!scalars
 integer :: found,iatom1,iatom2,iatsy1,iatsy2,ibranch,idir1,idir2,idisy1,idisy2
 integer :: ipert1,ipert2,ipertsy1,ipertsy2,isign,isym,ithree,itim,jbranch
 integer :: ndirs,new,noccur,quit,quit1,sympertcase
...
!DEBUG
!write(6,*)' mk_irredpert : enter mk_irredpert '
!write(6,*)' mk_irredpert : qtimrev=',qtimrev
!ENDDEBUG
...
!     write (*,*) 'trying to eliminate ',idir1,iatom1,idir2,iatom2
...
!DEBUG
!write (*,*) ' mk_irredpert : irredpert for qpt ',iqptfull,' = '
!do ibranch=1,nbranch
!do jbranch=1,nbranch
!write (*,'(2i4,2x,7i6)') ibranch,jbranch,irredpert(:,ibranch,jbranch,iqptfull)
!end do
!end do
!ENDDEBUG
