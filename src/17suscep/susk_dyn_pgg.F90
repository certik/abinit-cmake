...
!scalars
 ...
 real(dp) :: ai,ar,eigdiff,norm,normr,occ_fix,occdiff,tolocc,weight,wght1,wght2
...
!ENDDEBUG
 ...
 if(occopt>=3) then
  write(6,*) ' %susk_dyn_pgg: occopt>=3 not implemented: stop ' !MF
  stop
 end if
...
!DEBUG
!if(extrap==1)then
!write(6,*)' %susk_dyn_pgg: extrapolation: weights for diagonal term:'
...
!  DEBUG
!  write(6,*)' susk_dyn_pgg : will call fourwf for band',iband
!  ENDDEBUG
...
!     DEBUG
!     write(6,*) ' %susk_dyn_pgg: show on-diagonal weights:'
...
!    end do
!    end do
!    write(6,'(a,i4,2(1x,es14.6))') 'susk_dyn_pgg: sum wfraug=',iband,&
!    weight/nfftdiel
!    weight=0._dp
!    ENDDEBUG
...
! end do
! end do
! write(6,'(a,i4,2(1x,es14.6))') 'susk_dyn_pgg: sum rhoextrap=',iband,weight/nfftdiel*ucvol
! weight=0._dp
! end if
! ENDDEBUG
...
!DEBUG
!write(6,*)' %susk_dyn_pgg: END get real space wavefunctions'
!write(6,*)' susk_dyn_pgg : stop '
!stop
!ENDDEBUG
...
!    DEBUG
!    write(6,*)'%susk_dyn_pgg : contribution from bands',ibd1,ibd2
...
!     DEBUG
!     write(6,*) ' %susk_dyn_pgg: off-diagonal part ibd1, ibd2=',ibd1,ibd2
!     ENDDEBUG
...
!      DEBUG
!      write(6,*) ' %susk_dyn_pgg: show off-diagonal weights:'
...
!DEBUG
!write(6,*)' %susk_dyn_pgg: ! susmat_dyn(): diagonal elements'
!do ifreq=1,nfreq
!write(6,*) 'ifreq:',ifreq
!do ipw1=1,npwdiel
...
!end do
!end do
!write(6,*)' %susk_dyn_pgg : DONE & EXIT'; write(6,*)
!ENDDEBUG
