...
!This section has been created automatically by the script Abilint (TD). Do not modify the following lines by hand.
 ...
 use interfaces_17suscep, except_this_one => acfd_intexact
...
!scalars
 integer :: iband,info,ipw,ipw0,ipw1,ipw2,isp
...
#ifdef VMS
!DEC$ ATTRIBUTES ALIAS:'ZGETRF' :: zgetrf
#endif
...
!Allocate memory.
 ...
 allocate(diag(2,npwdiel))
 allocate(susmatk(2,npwdiel,npwdiel))
...
! First compute susmatk*susmatk**h using ZHERK...
  ...
  allocate(susmatk2(2,npwdiel,npwdiel))
