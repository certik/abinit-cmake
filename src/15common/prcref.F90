...
!This section has been created automatically by the script Abilint (TD). Do not modify the following lines by hand.
 ...
 use interfaces_13xc
 use interfaces_15common, except_this_one => prcref
...
!arrays
 ...
 real(dp),intent(in) :: dielar(7),fcart(3,dtset%natom),rhog(2,nfft),rhor(nfft,dtset%nspden)
...
&    ' prcref : ERROR -',ch10,&
&    'iprcel>20 Does not work yet for nspden=4 !'
