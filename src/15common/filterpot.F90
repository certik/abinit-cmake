...
!Also check if the booked space was large enough...
 ...
 allocate(wkcmpx(2,nfft),work(nfft))
...
! DEBUG
! write(6,*)' filterpot : before fourdp'
! write(6,*)' cplex,nfft,ngfft',cplex,nfft,ngfft
...
!DEBUG
!write(6,*)' filterpot : after fourdp'
!write(6,*)' cplex,nfft,ngfft',cplex,nfft,ngfft
!write(6,*)' maxval work1=',maxval(abs(work1))
!write(6,*)' maxval vhartr=',maxval(abs(vhartr))
!write(6,*)' filterpot : set vhartr to zero'
!vpot(:,:)=0.0_dp
!ENDDEBUG
