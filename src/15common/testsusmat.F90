...
!!
!! CHILDREN
!!      dielmt,dieltcel,fourdp,fresid,getph,kgindex,leave_new,mean_fftr,metric
...
!DEBUG
!if (compute) then
!write(0,*) 'testsusmat : TRUE'
!else
!write(0,*) 'testsusmat : FALSE',dielop,dielstrt,istep,dtset%iprcel,modulo(istep,10),&
