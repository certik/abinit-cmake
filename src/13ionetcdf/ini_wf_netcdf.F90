...
!!
!! PARENTS
!!      getgsc,inwffil,newsp,outwf,uderiv,vtorho,vtorho3
!!
!! CHILDREN
!!      handle_ncerr
!!
...
!DEBUG
!write(*,*)' ini_wf_netcdf: enter'
!write(*,*)' ini_wf_netcdf: arguments = ', mpw,ncid_hdr,response
!stop
!ENDDEBUG
...
! DEBUG
! write (*,*) 'ini_wf_netcdf : inquiring kg'
...
! probably not needed
  ...
  write (*,*) 'ini_wf_netcdf : finished defining variables in netCDF'
