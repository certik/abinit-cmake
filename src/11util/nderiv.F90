...
! Normal exit
  ...
  zz(ndim)=h1*(3.d0*y1-16.d0*yy(ndim-3)+36.d0*yy(ndim-2) &
  -48.d0*yy(ndim-1)+25.d0*yy(ndim))
  zz(ndim-1)=aa
  zz(ndim-2)=cc
  zz(ndim-3)=bb
...
! Normal exit
  ...
  zz(ndim)=h1*(11.d0*y1-56.d0*yy(ndim-3)+114.d0*yy(ndim-2) &
  -104.d0*yy(ndim-1)+35.d0*yy(ndim))
  zz(ndim-1)=aa
  zz(ndim-2)=cc
  zz(ndim-3)=bb
