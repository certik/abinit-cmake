...
!!
!! COPYRIGHT
!! Copyright (C) 1998-2008 ABINIT group (DCA, XG, FrD, GZ)
...
!Zero out Kleinman-Bylander energies ekb
 ...
 allocate(work1(mqgrid),work2(mqgrid),work3(mqgrid),work4(mqgrid))
...
!  Fit spline to get second derivatives by spline fit
   call spline(qgrid,ffspl(1,1,1),mqgrid,yp1,ypn,ffspl(1,2,1),work1)
...
!   Fit spline for l=1 Kleinman-Bylander form factor
    call spline(qgrid,ffspl(1,1,2),mqgrid,yp1,ypn,ffspl(1,2,2),work2)
...
!   Fit spline for l=2 Kleinman-Bylander form factor
    call spline(qgrid,ffspl(1,1,3),mqgrid,yp1,ypn,ffspl(1,2,3),work3)
...
!   Fit spline for l=3 Kleinman-Bylander form factor
    call spline(qgrid,ffspl(1,1,4),mqgrid,yp1,ypn,ffspl(1,2,4),work4)
...
!DEBUG
!write(06,*) 'EKB=',(ekb(iq),iq=1,3)
!write(06,*) 'COSKB=',(ckb(iq),iq=1,3)
!ENDDEBUG
