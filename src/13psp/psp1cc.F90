...
!This section has been created automatically by the script Abilint (TD). Do not modify the following lines by hand.
 ...
 use interfaces_13psp, except_this_one => psp1cc
...
! *************************************************************************
 ...
 allocate(ff(n1xccc),ff2(n1xccc),work(n1xccc),yy(n1xccc))
...
! Produce second derivative numerically, for use with splines
  call spline(yy,ff,n1xccc,der1,dern,ff2,work)
  xccc1d(:,ider+1)=ff(:)
  xccc1d(:,ider+3)=ff2(:)
...
!write(6,*)'   yy          gg           gp  '
!do i1xccc=1,n1xccc
!write(6, '(3es14.6)' ) yy(i1xccc),xccc1d(i1xccc,1),xccc1d(i1xccc,2)
!end do
!write(6,*)'   yy          gpp          gg2  '
!do i1xccc=1,n1xccc
!write(6, '(3es14.6)' ) yy(i1xccc),xccc1d(i1xccc,3),xccc1d(i1xccc,4)
!end do
!write(6,*)'   yy          gp2          gpp2  '
!do i1xccc=1,n1xccc
!write(6, '(3es14.6)' ) yy(i1xccc),xccc1d(i1xccc,5),xccc1d(i1xccc,6)
!end do
!write(6,*)' psp1cc : debug done, stop '
!stop
!ENDDEBUG

 deallocate(ff,ff2,work,yy)
