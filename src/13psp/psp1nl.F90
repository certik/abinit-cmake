...
!This section has been created automatically by the script Abilint (TD). Do not modify the following lines by hand.
 ...
 use interfaces_13psp, except_this_one => psp1nl
...
! "dvwf" consistently refers to dV(r)*wf(r) where dV=nonlocal correction
  ...
  allocate(work1(mmax+1),work2(mmax+1),work_spl(mqgrid),work5(mmax),besjx(mmax))
...
!   DEBUG
!   write(6,*)' psp1nl : write eta(lp1)'
!   write(6,*)result
!   do ir=1,mmax,61
!   write(6,*)vpspll(ir,lp1),vloc(ir),wfll(ir,lp1)
!   end do
!   write(6,*)
!   do ir=1,mmax,61
!   write(6,*)work1(ir),rad(ir),dr(ir)
!   end do
!   ENDDEBUG
...
!   Ask irmax to be lower than mmax
    ...
    allocate(work3(irmax-1),work4(irmax-1)) !Temporary arrays (Intel compiler compatibility)
...
!  End loop on angular momenta
  ...
  deallocate(work1,work2,work_spl,work5,besjx)
