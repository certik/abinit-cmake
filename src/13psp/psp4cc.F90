...
& ))))))))))*(1.0d0-3.d0*x**2)*(-4.d0)
 ...
 allocate(ff(n1xccc),ff2(n1xccc),work(n1xccc),xx(n1xccc))
...
! Produce second derivative numerically, for use with splines
  call spline(xx,ff,n1xccc,der1,dern,ff2,work)
  xccc1d(:,ider+1)=ff(:)
  xccc1d(:,ider+3)=ff2(:)
...
!write(6,*)'   xx          gg           gp  '
!do i1xccc=1,n1xccc
!write(6, '(3es14.6)' ) xx(i1xccc),xccc1d(i1xccc,1),xccc1d(i1xccc,2)
!end do
!write(6,*)'   xx          gpp          gg2  '
!do i1xccc=1,n1xccc
!write(6, '(3es14.6)' ) xx(i1xccc),xccc1d(i1xccc,3),xccc1d(i1xccc,4)
!end do
!write(6,*)'   xx          gp2          gpp2  '
!do i1xccc=1,n1xccc
!write(6, '(3es14.6)' ) xx(i1xccc),xccc1d(i1xccc,5),xccc1d(i1xccc,6)
!end do
