...
!This section has been created automatically by the script Abilint (TD). Do not modify the following lines by hand.
 ...
 use interfaces_lib01fftnew, except_this_one => forw_wf
...
!DEBUG
!       write(6,*)' forwf_wf : after unswitch_cent, j3=',j3
!ENDDEBUG
...
!DEBUG
!       write(6,*)' forwf_wf : interproc data transp'
!ENDDEBUG
...
!DEBUG
!       write(6,*)' forwf_wf : before unscramble, j2,md2proc,iproc,m2=',j2,md2proc,iproc,m2
!ENDDEBUG
...
!ENDDEBUG
!DEBUG
!       write(6,'(a,3i4)' )'forw_wf exit ,zf n1,n2,n3',n1,n2,n3
!       write(6,'(a,3i4)' )'nd1,nd2,nd3proc',nd1,nd2,nd3proc
!       write(6,'(a,3i4)' )'m1,m2,m3',m1,m2,m3
!        write(6,'(a,3i4)' )'max1,max2,max3',max1,max2,max3
!        write(6,'(a,3i4)' )'md1,md2proc,md3',md1,md2proc,md3
