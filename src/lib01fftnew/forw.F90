...
!This section has been created automatically by the script Abilint (TD). Do not modify the following lines by hand.
 use interfaces_lib01fftnew, except_this_one => forw
...
!DEBUG
!       write(6,*)' forw : enter '
!       write(6,'(a,3i4)' )'forw_wf, entre, i1,i2,i3,zr,n1,n2,n3',n1,n2,n3
!       do i3=1,nd3proc
!        do i2=1,n2
!         do i1=1,n1
!          write(6, '(3i4,2es16.6)')i1,i2,i3,zr(1:2,i1,i2,i3)
!         end do
!        end do
!       end do
...
!        write(6,*) 'J2st,Jp2st',J2st,Jp2st
        if (mpi_enreg%nproc_fft.eq.1) then
         call unmpiswitch(j3,n1dfft,Jp2st,J2st,lot,n1,nd2proc,nd3proc,mpi_enreg%nproc_fft,option,zw(1,1,inzee),zmpi2)
        else
         call unmpiswitch(j3,n1dfft,Jp2st,J2st,lot,n1,nd2proc,nd3proc,mpi_enreg%nproc_fft,option,zw(1,1,inzee),zmpi1)
        end if
