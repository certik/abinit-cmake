...
!This section has been created automatically by the script Abilint (TD). Do not modify the following lines by hand.
 use interfaces_lib01fftnew, except_this_one => accrho
...
! real space input
        ...
        integer            :: md1,md2proc,md3,nproc,iproc,paral_kgb
...
!$omp critical
        ...
        if (npr.gt.1) allocate(rhopart(nd1,nd2,nd3proc))
!$omp end critical
...
!       do i1=1,n1
!        do i2=1,n2
!         write(6, '(2i4,2es16.6)')i1,i2,rho(i1,i2,j3)
!        end do
!       end do
!       stop
!ENDDEBUG
...
!$omp end critical
        ...
        if (npr.gt.1) deallocate(rhopart)
!$omp end parallel
