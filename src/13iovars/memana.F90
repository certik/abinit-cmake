...
!!  nfftdiel  =(effective) number of fft grid points for susceptibility
!!    and dielectric matrices (for one processor)
...
!scalars
 ...
 integer,intent(in) :: nfft,nfftdiel,nfftf,occopt,option,prtvol,usepaw
...
!Local variables-------------------------------
!scalars
 integer :: biggest,ichain,ier,ier1,ier2,ier3,ier4,ier5,ier6,ier7,ier8,ii,jj,kk
