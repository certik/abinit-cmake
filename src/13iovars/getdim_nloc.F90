...
!Local variables-------------------------------
!scalars
 integer :: ilang,ipsp,ipspalch,itypalch,itypat,llmax,ntyppure
...
!DEBUG
!write(6,*)' getdim_nloc : enter'
!ENDDEBUG

 allocate(lmnproj_typat(ntypat),lmnprojso_typat(ntypat))
 allocate(lnproj_typat(ntypat),lnprojso_typat(ntypat))
 allocate(nproj_typat(0:3,ntypat),nprojso_typat(3,ntypat))
...
& '                      lmnmaxso=',lmnmaxso,', lnmaxso=',lnmaxso,'.'
 ...
 deallocate(lmnproj_typat,lmnprojso_typat)
 deallocate(lnproj_typat,lnprojso_typat)
 deallocate(nproj_typat,nprojso_typat)

!DEBUG
!write(6,*)' getdim_nloc : exit'
!stop
!ENDDEBUG
