...
!!
!! COPYRIGHT
!! Copyright (C) 2000-2008 ABINIT group (DRH, XG)
...
!scalars
 ...
 integer :: i1,i2,i3,ia,ia1,ia2,id1,id2,id3,ielt,ieltx,ierr,ig1,ig2,ig3,ii,ir
 ...
 real(dp) :: aa,bb,c1,c2,c3,c4,cc,cutoff,d2g,d2gsqds,d2gss,dbl_ig1,dbl_ig2
 real(dp) :: dbl_ig3,dd,dg1,dg2,dgsqds,dgss1,dgss2,diff,dn,dnm1,dnm2,dnp1,dq
 real(dp) :: dq2div6,dqdiv6,dqm1,ee,ff,gmag,gsq,gsquar,gsv2int,ph1,ph12i,ph12r
 real(dp) :: ph1i,ph1r,ph2,ph2i,ph2r,ph3,ph3i,ph3r,phi,phimag,phimag_igia,phr
 real(dp) :: phre,phre_igia,sfgi,sfgr,sfi,sfr,svion,svioni,svionr,term,term1
 real(dp) :: term2,term3,term4,term5,vion1,vion2,vion3,x1,x2,x3,xnorm,y1,y2,y3
 character(len=500) :: message
!arrays
 integer,save :: idx(12)=(/1,1,2,2,3,3,3,2,3,1,2,1/)
 real(dp) :: dgm(3,3,6),dgmetds(3,3),tsec(2)
...
!Define 2dG^2/ds1ds2  based on G space metric derivative dgmetds.
