...
!scalars
 ...
 real(dp) :: arg,arga,argb,c1i,c1r,da1,da2,da3,derfc_arg,dgda1,dgda2,dgda3
 real(dp) :: direct,dot1,dot2,dot3,dotr1,dotr2,dotr3,drda1,drda2,drda3,drdta1
 real(dp) :: drdta2,drdta3,eew,eta,fac,gdot12,gdot13,gdot23,gsq,gsum,norm1,phi
 real(dp) :: phr,r1,r1a1d,r2,r2a2d,r3,r3a3d,rdot12,rdot13,rdot23,recip,reta
 real(dp) :: reta3m,rmagn,rsq,sumg,summi,summr,sumr,t1,t2,term,term1,term2
 real(dp) :: term3,wall
