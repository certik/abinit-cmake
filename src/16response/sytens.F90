...
!scalars
 ...
 integer :: i3dir,i3dir_,i3pert,i3pert_,idisy1,idisy2,idisy3,ii,ipesy1,ipesy2
 integer :: ipesy3,isign,isym,itirev,jj
!arrays
...
!DEBUG
!write(6,*)'sytens : enter'
!write(6,*)'indsym = '
!write(6,*)indsym
!stop
!ENDDEBUG

 allocate(pertsy(3,mpert,3,mpert,3,mpert))
 pertsy(:,:,:,:,:,:) = 0
