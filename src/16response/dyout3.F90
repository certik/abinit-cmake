...
!!  dyfrnl(3,3,natom)=frozen wf nonloc part of the DYMX
...
!!  d2vn(2,3,mpert,3,mpert)=potential*dens station. part of the D2MX
!!                        and without masses included)
...
!Arguments -------------------------------
!scalars
 integer,intent(in) :: berryopt,ddboun,iout,mband,mpert,natom,ntypat,outd2
 integer,intent(in) :: prtbbb,prtvol,qzero,rfphon,rfstrs
!arrays
 ...
 real(dp),intent(in) :: d2nl1(2,3,mpert,3,mpert),d2vn(2,3,mpert,3,mpert)
 real(dp),intent(in) :: dyew(2,3,natom,3,natom),dyfrlo(3,3,natom)
 real(dp),intent(in) :: dyfrnl(3,3,natom),dyfrx1(2,3,natom,3,natom)
 real(dp),intent(in) :: dyfrx2(3,3,natom),eltcore(6,6),elteew(6+3*natom,6)
...
!Local variables -------------------------
!scalars
 integer :: iband,idir1,idir2,ii,ipert1,ipert2,jj,nelmts,nline,qdir
...
!  write the  Ewald part of the dynamical matrix
   ...
   do ipert1=1,natom
    do idir1=1,3
!    write(6,*)ipert1,idir1,rfpert(ipert1),rfdir(idir1)
       ...
       do idir2=1,3
        if(rfpert(ipert2)==1.and.rfdir(idir2)==1)then
         if(ipert1==ipert2)then
          write(iout,'(2(i4,i5),2(1x,f20.10))')idir1,ipert1,idir2,ipert2,&
&          dyfrlo(idir1,idir2,ipert2),0.0_dp
         else
          write(iout,'(2(i4,i5),2(1x,f20.10))')idir1,ipert1,idir2,ipert2,&
&          0.0_dp,0.0_dp
         end if
      ...
      do ipert2=1,natom
       do idir2=1,3
        if(rfpert(ipert2)==1.and.rfdir(idir2)==1)then
         if(ipert1==ipert2)then
          write(iout,'(2(i4,i5),2(1x,f20.10))')idir1,ipert1,idir2,ipert2,&
&          dyfrnl(idir1,idir2,ipert2),0.0_dp
         else
          write(iout,'(2(i4,i5),2(1x,f20.10))')idir1,ipert1,idir2,ipert2,&
&          0.0_dp,0.0_dp
         end if
      ...
      do ipert2=1,natom
       do idir2=1,3
        if(rfpert(ipert2)==1.and.rfdir(idir2)==1)then
         if(ipert1==ipert2)then
          write(iout,'(2(i4,i5),2(1x,f20.10))')idir1,ipert1,idir2,ipert2,&
&          dyfrx2(idir1,idir2,ipert2),0.0_dp
         else
          write(iout,'(2(i4,i5),2(1x,f20.10))')idir1,ipert1,idir2,ipert2,&
&          0.0_dp,0.0_dp
         end if
...
! Now the nonlocal nonstationary nonfrozenwf part
  if (outd2==1)then
   write(iout,*)' '
   write(iout,*)' Non-stationary non-local part of the 2nd-order',&
&   'matrix'
   write(iout,*)'    j1       j2             matrix element'
   write(iout,*)' dir pert dir pert     real part   imaginary part'
   do ipert1=1,mpert
...
! Now the 0-order local stationary nonfrozenwf part
  if (outd2==2)then
   write(iout,*)' '
   write(iout,*)' Stationary 0-order local part of the 2nd-order',&
&   'matrix'
   write(iout,*)'    j1       j2             matrix element'
   write(iout,*)' dir pert dir pert     real part   imaginary part'
   do ipert1=1,mpert
...
! Now the stationary 0-order kinetic nonfrozenwf part
  if (outd2==2)then
   write(iout,*)' '
   write(iout,*)' Stationary 0-order kinetic part of the 2nd-order'&
&   ,'matrix'
   write(iout,*)'    j1       j2             matrix element'
   write(iout,*)' dir pert dir pert     real part   imaginary part'
   do ipert1=1,mpert
...
&       d2cart_bbb(2,idir1,idir2,ipert2,iband,iband)
 ...
 if(rfpert(natom+5)==1)then ! this is for testing rfmgfd
...
&       d2cart_bbb(2,idir1,idir2,ipert2,iband,iband)
 ...
 end if ! end natom+5 dielectric output, for testing rfmgfd
