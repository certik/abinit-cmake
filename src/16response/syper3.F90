...
!!
!! OUTPUT
!!   pertsy(3,mpert)= the target perturbation is described
!!              by the two last indices (idir, and ipert),
!!              the value is 0, 1 or -1, see notes.
!!
!! NOTES
!! Output will be in the pertsy array,
!! being 0 for non-target perturbations
!! being 1 for basis perturbations
!! being -1 for perturbations that can be found from
!!             basis perturbations
!!
!! PARENTS
!!      respfn
...
!   DEBUG
!   write(6,*)' for candidate idir =',idir1,&
!   &            ' ipert = ',ipert1
!   ENDDEBUG
...
!       write(6,1010)((sym1(ii,jj),ii=1,3),jj=1,3)
!       write(6,1010)((sym2(ii,jj),ii=1,3),jj=1,3)
!       write(6,*)sumr,sumi
!       1010    format(9i4)
!       ENDDEBUG
...
!   DEBUG
!   write(6, '(a,3i5)' ) ' syper3 :',idir1,ipert1,pertsy(idir1,ipert1)
!   ENDDEBUG
