...
!Local variables -------------------------
!scalars
 integer :: i1,i2,i3,ia,ia1,ia2,iatom,id1,id2,id3,ig1,ig2,ig3,ii,ii1,im=2,isign
 integer :: itypat,jj,jtemp,nri,re=1
 real(dp),parameter :: tolfix=1.000000001_dp
 real(dp) :: aa,bb,cc,cutoff,dd,diff,dq,dq2div6,dqdiv6,dqm1,g1,g2,g3,gmag,gq1
 real(dp) :: gq2,gq3,gsq,gsquar,norm,ph1,ph2,ph3,phi,phimag,phqim,phqre,phr
 real(dp) :: phre,qxred2pi,ratio,sfi,sfr,vion1,x1,x2,x3,xnorm,y1,y2,y3
 logical :: qeq0
!arrays
 integer :: ng(3)
 real(dp) :: gq(3)
...
!DEBUG
!write(6,*)' vloca3 : ir,vpsp1(ir),vpsp1(ir+1)'
!do ii=1,nfft,42
!write(6, '(i5,2es16.6)' )ii,vpsp1(ii),vpsp1(ii+1)
!end do
!stop
!ENDDEBUG
