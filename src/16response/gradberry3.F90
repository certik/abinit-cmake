...
!Local variables -------------------------
!scalars
 integer :: count,iband,icg,icg1,idir,ifor,ikgm1,ikgn,ikgnm1,ikgnp1,ikgp1,ikpt1
 integer :: ikpt1m,ikptn,ikptnm,ikptnm1,ikptnp1,info,ipw,jband,jpw,kband
...
! *************************************************************************
 ...
 allocate(s1mat(2,dtefield%nband_occ,dtefield%nband_occ),pwind_tmp(mpw_tmp))
 allocate(Amat(2,dtefield%nband_occ,dtefield%nband_occ),Bmat(2,dtefield%nband_occ,dtefield%nband_occ))
...
! write(6,*)'cgwf3:pwind_tmp',pwind_tmp
! stop
...
! preparation
 ...
 deallocate(vect1,vect2,s1mat,Amat,Bmat)
 deallocate(pwind_tmp)
