...
!!
!! COPYRIGHT
!! Copyright (C) 2002-2008 ABINIT group (DCA, XG)
...
!!
!! PARENTS
!!      dens_in_sph,eltfrkin3,eltfrnl3,energy,getgsc,ladielmt,lavnl,mkrho
!!      mkrho3,mlwfovlp,outkss,overlap_wf,prctfvw1,prctfvw2,prep_fourwf
!!      prep_getghc,resp3dte,rhofermi3,scfcv,spin_current,suscep,suscep_dyn
!!      suscep_kxc_dyn,suscep_stat,susk,tddft,vtorho,vtorho3,wfconv,wffile
!!      wfread
!!
!! CHILDREN
!!      leave_new,wrtout
...
!
!DEBUG
!write(6,*)' sphereboundary : enter'
!write(6, '(a)' )' sphereboundary : list of plane waves coordinates for k point '
!write(6, '(a)' )'       ipw       kg_k(1:3,ipw) '
!do ipw=1,npw
! write(6, '(i10,a,3i6)' )ipw,'  ',kg_k(1:3,ipw)
!end do
!call flush(6)
!ENDDEBUG
...
!    Endif take into account time-reversal symmetry
     end if
...
!DEBUG
!write(6,*)' sphereboundary : exit '
! write(6, '(a)' )' sphereoundary : list of plane waves coordinates for 1st k point '
! write(6, '(a)' )'       ipw       kg_k(1:3,ipw) '
! do ipw=1,npw
!  write(6, '(i10,a,3i6)' )ipw,'  ',kg_k(1:3,ipw)
! end do
! write(6, '(a)' )' sphereboundary : list of boundaries '
! do igb=1,2*mgfft+8
!  write(6, '(i10,a,2i6)' )igb,'  ',gbound(igb,1),gbound(igb,2)
! end do
! call flush(6)
! stop
!ENDDEBUG
