...
!!      jvec_to_B,localorb_S,make_efg_el,make_efg_ion,make_fc_el,mklocl
!!      mklocl_realspace,moldyn,move,out1dm,out_geometry_xml,outqmc,outvars
!!      partial_dos_fractions,prcref,prcref_PMA,prtspgroup,rdddb9,relaxpol
!!      symspgr,vtorho,wffile,wvl_init_type_proj,wvl_init_type_wfs,wvl_memory
!!      wvl_rwwf,wvl_setboxgeometry,wvl_wfsinp_reformat,wvl_wfsinp_scratch
!!
!! CHILDREN
