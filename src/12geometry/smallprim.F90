...
!!
!! INPUTS
!!  rmet(3,3)=metmin for the input primitive vectors
...
!! rmet and metmin as arguments, but it is more convenient to have them
!!
!! PARENTS
!!      getkgrid,symbrav,testkgrid
!!
!! CHILDREN
!!      leave_new,wrtout
!!
...
!scalars
 ...
 real(dp) :: determinant,length2
 character(len=500) :: message
!arrays
 integer :: nvecta(3),nvectb(3)
 real(dp) :: scprod(3),tmpvect(3)
