...
!!
!! PARENTS
!!      afterscfloop,anascr,brdmin,chkinp,conducti_nc,conducti_paw
!!      crystal_methods,cutoff_cylinder,delocint,dyfnl3,eltfrhar3,eltfrkin3
!!      eltfrnl3,eltfrxc3,energy,forces,forstrnps,getkgrid,hirsh,ingeo,initaim
!!      inkpts,invacuum,invars2m,ladielmt,lavnl,linear_optics_paw,localorb_S
!!      loper3,m_commutator_vkbr,moddiel,moldyn,mrgscr,newrho,newsp,newvtr
!!      newvtr3,nres2vres,optic,overlap_wf,partial_dos_fractions,pawgrnl,prcref
!!      prcref_PMA,prctfvw1,prctfvw2,prctfw3,rdddb9,rdm,rhohxc,scfcv,scfcv3
!!      screening,setup1,setup_coulombian,setup_kmesh,setup_qmesh,sigma,stress
!!      suscep,testkgrid,tetrahedron,wannier,wffile,wfread,xfpack
!!
!! CHILDREN
