...
!!    Shubnikov type IV magnetic groups (if zero, the group is not a type IV magnetic group)
!!  iout=unit number of output file
!!  jdtset= actual number of the dataset to be read
!!  ptgroupma  =magnetic point group, in case of
!!    Shubnikov type III magnetic groups (if zero, the group is not a type III magnetic group)
...
!This section has been created automatically by the script Abilint (TD). Do not modify the following lines by hand.
 ...
 use interfaces_12geometry, except_this_one => prtspgroup
