!!****m* ABINIT/interfaces_lib01fftnew
!! NAME
!! interfaces_lib01fftnew
!!
!! FUNCTION
!! This module contains the interfaces of the routines
!! in the directory src/lib01fftnew
!!
!! COPYRIGHT
...
module interfaces_lib01fftnew

 implicit none

interface
 subroutine accrho(icplexwf,ndat,n1,n2,n3,nd1,nd2,nd3proc,&  
  &  max1,max2,max3,m1,m2,m3,md1,md2proc,md3,nproc,iproc,paral_kgb,zf,rho,weight)
  use defs_basis
  implicit none
  integer :: icplexwf
  integer :: iproc
...
interface
 subroutine slice(nproc,iproc,m1,m2,m3,n1,n2,n3,md1,md2,md3,nd1,nd2,nd3,zf,zr)
  use defs_basis
  implicit none
  integer :: iproc
  integer :: m1
...
end module interfaces_lib01fftnew
!!***
