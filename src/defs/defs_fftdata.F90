...
!!
!! COPYRIGHT
!! Copyright (C) 2000-2008 ABINIT group (LG, PMA)
!! This file is distributed under the terms of the
!! GNU General Public License, see ~abinit/COPYING
!! or http://www.gnu.org/copyleft/gpl.txt .
!!
!! NOTES
!! 1) The GW part of Abinit uses different fft routines and must not 
!! depend on this modules (2007/02/06)
!! 2) Most of those number are choosen arbitrarily but any modification
!! should be done keeping in mind the overall coherency.
!! 3) ifftdata cannot be constructed directly in one big reshape instruction,
