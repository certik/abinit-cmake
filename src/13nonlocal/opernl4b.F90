...
!This section has been created automatically by the script Abilint (TD). Do not modify the following lines by hand.
 ...
 use interfaces_13nonlocal, except_this_one => opernl4b
...
!scalars
 ...
 integer,intent(in) :: mincat,mlang3,mlang4,mlang6,mproj,ndgxdt,nffnl,nincat
...
!scalars
 ...
 integer :: ilangx,iproj,ipw,ipw1,ipw2,jffkg,jj,jjs,jump,mblkpw,mmproj,mu,nffkg
...
!   DEBUG
!   write(6,*)' opernl4b, write scalars '
!   do iffkg=1,nffkg
