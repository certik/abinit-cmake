...
!Arguments ------------------------------------
!scalars
 integer,intent(in) :: choice,cplex,cplex_fac,ia3,ia5,lmnmax,natom,nd2gxdt,ndgxdt
...
!Local variables-------------------------------
!scalars
 integer :: ia,iashift,ilmn,iplex,ishift,ispinor,mu,mua,mub,mushift,nu,nushift
 real(dp) :: factvol
!arrays
 integer,parameter :: alpha(6)=(/1,2,3,3,3,2/),beta(6)=(/1,2,3,2,1,1/)
 real(dp) :: enlj(6),gxfacj(cplex),gxi(cplex),gxj(cplex)
