...
!Local variables ------------------------------
!scalars
 integer :: aliasing_factor,fftalg,ig,ig1,ig1max,ig2,ig2max,ig3,ig3max,ii,index
 integer :: is,m1,m2,m3,mm1,mm2,mm3,n1,n2,n3,nt,unt
 real(dp) :: ecuteff,ecutsigx,ecutwfn,g1,g2,g3,gsq,gsqmax,reff,rsigx,rwfn
 logical :: fft_ok,fftfile
...
!  close(unt)
!  else 
!  write(msg,'(5a)')' old_setmesh : ERROR : ',ch10,' FFT file ',TRIM(fnam),' not found'
!  call wrtout(std_out,msg,'COLL') 
!  call leave_new('COLL')
!  end if 
