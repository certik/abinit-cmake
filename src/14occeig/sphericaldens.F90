...
!!
!! FUNCTION
!! Compute the convolution of a function with a
...
!! The routine need the norm of the reciprocal space vectors.
!!
...
!!
!! COPYRIGHT
!! Copyright (C) 2003-2008 ABINIT group (MV,XG)
