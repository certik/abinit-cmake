...
!!
!! PARENTS
!!      dyxc13,eneres3,loop3dte,nstdy3,scfcv3
!!
!! CHILDREN
...
!This section has been created automatically by the script Abilint (TD). Do not modify the following lines by hand.
 ...
 use interfaces_13xc, except_this_one => mkvxc3
...
!arrays
 ...
 real(dp),intent(in) :: gmet(3,3),kxc(nfft,nkxc),qphon(3)
...
! First transfer the data to spin-polarized storage
  ...
  call mkvxcgga3(cplex,gmet,gprimd,gsqcut,kxc,mpi_enreg,nfft,ngfft,nkxc,&
...
!DEBUG
!write(6,'(a)') ' mkvxc3 :  '
!write(6,'(a)') '   ir     rhor1(ir)     vxc1(ir)       kxc(ir) '
!if(cplex==1)then
!do ir=1,nfft
