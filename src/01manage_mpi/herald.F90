...
!!
!! PARENTS
!!      abinit,aim,anaddb,anascr,cut3d,mrgddb,mrggkk,mrgscr,newsp,optic
!!
!! CHILDREN
!!      date_and_time
!!
...
!This section has been created automatically by the script Abilint (TD). Do not modify the following lines by hand.
 use interfaces_01manage_mpi, except_this_one => herald
...
& ' see ~abinit/COPYING or http://www.gnu.org/copyleft/gpl.txt).'
 ...
 if(trim(code_name)=='ABINIT-GW')then
  write(iout, '(a,a,a,/,a,/,a,/)' ) &
&  ' ',trim(code_name),' has originally been developed by',&
&  ' R.W. Godby, V. Olevano, G. Onida, L. Reining, M. Torrent,',&
