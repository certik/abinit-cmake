# This file will run one abinis built-in test in a separate process

# Copyright (C) 1999-2008 ABINIT group (LSi)
...
$abinis = &transpath("../../../src/main/abinis$XSUFX");
$timeout_cmd = &transpath("../../../src/nightly/timeout$XSUFX");
if ($SUFXstyle eq 'vms') {
